...
const botSecret = 'OTUzMjIxNjEzNzI4NDUyNjA4.YjBazg.svJTZmQDV4TNSsdqIm2PtIwGDew';

function getPrices() {


	// API for price data.
	axios.get(`https://api-mainnet.magiceden.dev/v2/collections/female_hodl_whales/stats`).then(res => {
		...
		if(res.data.floorPrice) {
			...
			client.user.setPresence({
				game: {
					...
					name: `Listed ${listings} | 24h: ${avgPrice.toFixed(2)} SOL`,
